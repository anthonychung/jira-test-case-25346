...
//@interface mL_Jira_TestObject : NSObject
//@end

@interface mL_Jira_TestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mL_Jira_TestObject class]])
		{
			for (NSString *key in [[(mL_Jira_TestObject*)o modules] allKeys])
			{
