...
@interface mL_Jira_TestObject : KrollCoverageObject {
#else
@interface mL_Jira_TestObject : KrollObject {
#endif
@private
...
extern NSString * mL_Jira_Test$ModuleRequireFormat;
...
@private
	...
	mL_Jira_TestObject *_ml_jira_test;
	KrollObject* console;
	BOOL shutdown;
