...
// in simulator we redefine to format for mL_Jira_Test Developer console
...
{\
	NSString * exceptionName = [@"org.ml_jira_test." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ml_jira_test";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImL_Jira_TestNativeItemNone = -1, 
	UImL_Jira_TestNativeItemSpinner = -2,
	UImL_Jira_TestNativeItemProgressBar = -3,
	
	UImL_Jira_TestNativeItemSlider = -4,
	UImL_Jira_TestNativeItemSwitch = -5,
	UImL_Jira_TestNativeItemMultiButton = -6,
	UImL_Jira_TestNativeItemSegmented = -7,
	
	UImL_Jira_TestNativeItemTextView = -8,
	UImL_Jira_TestNativeItemTextField = -9,
	UImL_Jira_TestNativeItemSearchBar = -10,
	
	UImL_Jira_TestNativeItemPicker = -11,
	UImL_Jira_TestNativeItemDatePicker = -12,
	
	UImL_Jira_TestNativeItemInfoLight = -13,
	UImL_Jira_TestNativeItemInfoDark = -14,
	
	UImL_Jira_TestNativeItemDisclosure = -15,
	
	UImL_Jira_TestNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all mL_Jira_Test instances of
