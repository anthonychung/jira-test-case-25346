...
/**
 Base class for all mL_Jira_Test views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the mL_Jira_Test view hierarchy (such as wrapped iOS UIViews) was touched.
