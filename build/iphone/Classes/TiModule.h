...
/**
 The base class for all mL_Jira_Test modules
 */
...
/**
 mL_Jira_Test Platform calls this method on startup.
 */
-(void)startup;

/**
 mL_Jira_Test Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 mL_Jira_Test Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 mL_Jira_Test Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 mL_Jira_Test Platform calls this method on resume.
 @param sender The sender of the event.
 */
