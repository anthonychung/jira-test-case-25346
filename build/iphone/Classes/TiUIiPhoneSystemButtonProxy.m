...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ACTIVITY,UImL_Jira_TestNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.ACTIVITY",@"5.4.0",@"UI.iOS.SystemButtonStyle.ACTIVITY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(SPINNER,UImL_Jira_TestNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.SPINNER",@"5.4.0",@"UI.iOS.SystemButtonStyle.SPINNER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_LIGHT,UImL_Jira_TestNativeItemInfoLight,@"UI.iPhone.SystemButtonStyle.INFO_LIGHT",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_DARK,UImL_Jira_TestNativeItemInfoDark,@"UI.iPhone.SystemButtonStyle.INFO_DARK",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_DARK");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(DISCLOSURE,UImL_Jira_TestNativeItemDisclosure,@"UI.iPhone.SystemButtonStyle.DISCLOSURE",@"5.4.0",@"UI.iOS.SystemButtonStyle.DISCLOSURE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(CONTACT_ADD,UImL_Jira_TestNativeItemContactAdd,@"UI.iPhone.SystemButtonStyle.CONTACT_ADD",@"5.4.0",@"UI.iOS.SystemButtonStyle.CONTACT_ADD");
