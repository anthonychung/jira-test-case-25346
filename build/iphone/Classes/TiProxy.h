...
//Rare exceptions to indicate a bug in the _ml_jira_test code (Eg, function that a subclass should have implemented)
...
/**
 The base class for mL_Jira_Test proxies.
 */
